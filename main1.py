...
from keras.api.layers import Conv2D, MaxPooling2D, Flatten, Input, Dense
...
def create_cnn_model(input_shape):
    ...
    x = Conv2D(filters=32, kernel_size=(2, 2), activation='relu')(inputs)
...
Dish_model = create_cnn_model((10,6,1))
Dish_model.summary()
Menu_Card_model = create_cnn_model((10,6,1))
Menu_Card_model.summary()
Mobile_model = create_cnn_model((5,6,1))
